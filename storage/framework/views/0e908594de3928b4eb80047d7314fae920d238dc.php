...
<?php $__empty_1 = true; $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <tr class="
        ...
        <td class="title">
            <?php if($list->rootId): ?>
               <a class="parent" target="_blank" href="http://www.guruchain.com/#/greatboss/1/boards/<?php echo e($list->cafeBoardId); ?>/articles/<?php echo e($list->rootId); ?>/read">원글</a>
            <?php endif; ?>
            <a class="<?php if($list->depth==1): ?> depth <?php endif; ?>" target="_blank" href="http://www.guruchain.com/#/greatboss/1/boards/<?php echo e($list->cafeBoardId); ?>/articles/<?php echo e($list->id); ?>/read"><?php echo e($list->title); ?></a>
